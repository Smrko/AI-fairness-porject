...
while count <= divide:
    ...
    model.fit(predictor_Uniform_Sampling, target_Uniform_Sampling.ravel())
...
book = load_workbook("C:\\Users\smrko\OneDrive\Desktop\AI_Neural_RF.xlsx")
writer = pd.ExcelWriter("C:\\Users\smrko\OneDrive\Desktop\AI_Neural_RF.xlsx", engine='openpyxl')
writer.book = book
