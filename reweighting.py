...
while count <= divide:
    ...
    # starting reweighting:  https://github.com/sjessa/fair-ML/blob/6746dea2a07436eee0c5ea60be4311f7564df216/code/preprocessing.py
    ...
    # calculating the specific class weights
    ...
    model = Sequential()
    n_cols = predictor_reweighting.shape[1]
    input_shape = (n_cols,)
    print(n_cols)
    ...
    model.fit(predictor_reweighting, target_reweighting, epochs=500, batch_size=1000, validation_data=valid_set,
              callbacks=[stopping], sample_weight=weight_training)
...
final_df.to_excel(writer, sheet_name='reweight')
writer.save()
