...
while count <= divide:
    ...
    Sample_structure = Sample_structure.assign(
        num=abs(round(0.7 * (Sample_structure["size"] - Sample_structure["weight"] * Sample_structure["size"]))))
    ...
    model.fit(predictor_Preferencial_Sampling, target_Preferencial_Sampling.ravel())
