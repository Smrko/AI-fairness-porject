...
while count <= divide:
    ...
    value = [accrucy, accrucy_woman, accrucy_man, accrucy_white, accrucy_non_white, FPR_man, FPR_woman, FNR_man, FNR_woman, FPR_White, FPR_Non_white, FNR_white, FNR_Non_white]
...
print(final_df)
'''from openpyxl import load_workbookC:\Users\shiri\.conda\envs\Shirin\lib\site-packages\numpy\.libs\libopenblas.XWYDX2IKJW2NMTWSFYNGFUWKQU3LYTCZ.gfortran-win_amd64.dll
