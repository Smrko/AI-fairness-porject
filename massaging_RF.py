...
while count <= divide:
    ...
    # https://github.com/sjessa/fair-ML/blob/6746dea2a07436eee0c5ea60be4311f7564df216/code/preprocessing.py the model comes from here
    R = GaussianNB()
    ...
    model.fit(predictor_relabel, target_relabel.ravel())
